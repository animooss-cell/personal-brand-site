        ...
        <div className="grid items-center gap-8 px-6 py-12 md:grid-cols-2 md:px-12 md:py-16">
          <div className="order-2 md:order-1">
            <span className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-1.5 text-sm font-medium text-brand-100">
              ...
              مشاوره کسب‌وکار و هوش مصنوعی
            </span>

            <h1 className="text-3xl font-extrabold leading-tight text-white md:text-5xl">
              کسب‌وکار خود را با{" "}
              <span className="text-brand-300">قدرت هوش مصنوعی</span> رشد دهید
            </h1>

            <p className="mt-5 max-w-xl text-base leading-7 text-slate-300">
              از راه‌اندازی استارتاپ تا اتوماسیون فرآیندها و کانتنت مارکتینگ هدفمند؛
              با مشاوره عملی، نتیجه‌محور و بدون پیچیدگی فنی.
            </p>
            ...
            <div className="mt-9 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-slate-400">مورد اعتماد بیش از ۵۰۰ کسب‌وکار</p>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 md:order-2">
            <div className="relative overflow-hidden rounded-3xl">
              <Image
                ...
                alt="مشاوره کسب‌وکار و هوش مصنوعی"
                width={800}
                height={900}
